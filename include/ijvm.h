...
#define OP_BIPUSH         ((byte_t) 0x10) //check
#define OP_DUP            ((byte_t) 0x59) //check
#define OP_ERR            ((byte_t) 0xFE)
#define OP_GOTO           ((byte_t) 0xA7) //check
#define OP_HALT           ((byte_t) 0xFF) //check
#define OP_IADD           ((byte_t) 0x60) //check
#define OP_IAND           ((byte_t) 0x7E) //check
...
#define OP_INVOKEVIRTUAL  ((byte_t) 0xB6) //check
#define OP_IOR            ((byte_t) 0xB0) //check
#define OP_IRETURN        ((byte_t) 0xAC)
#define OP_ISTORE         ((byte_t) 0x36) //check
#define OP_ISUB           ((byte_t) 0x64) //check
#define OP_LDC_W          ((byte_t) 0x13) //check
#define OP_NOP            ((byte_t) 0x00) //check
#define OP_OUT            ((byte_t) 0xFD) //check
#define OP_POP            ((byte_t) 0x57) //check
#define OP_SWAP           ((byte_t) 0x5F) //check
